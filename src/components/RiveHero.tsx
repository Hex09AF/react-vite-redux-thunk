...
export default function RiveHero() {
			...
			const resizeObserver = new ResizeObserver(
				throttle(() => {
					...
					if (rive && canvasContainerRef) {
						...
						if (canvasRef && (lastWidth !== newWidth || lastHeight !== newHeight)) {
	...
	const onMouseMove: MouseEventHandler<HTMLDivElement> = (e: MouseEvent<HTMLDivElement>) => {
		if (!numX || !numY) {
			return;
		}
	...
	return (
		<Box
			...
			w="100%"
			h="100%"
			className="rive-canvas-container"
